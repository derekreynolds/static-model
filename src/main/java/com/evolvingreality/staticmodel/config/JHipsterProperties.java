...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "staticmodel@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "staticmodel API";

        private String description = "staticmodel API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "staticmodel";
